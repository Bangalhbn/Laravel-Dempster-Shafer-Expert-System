...
@section('content-wrapper')
    <div class="row my-lg-5">
        <div class="col-sm-6 my-lg-5 my-5">
            <div class="my-lg-5">
                <h4 class="text-custom">Aplikasi Sistem Pakar Diagnosis Penyakit Tulang Manusia.</h4>
                <p class="text-custom-2">
                    Sistem pakar ini digunakan untuk menentukan jenis penyakit pada tulang.
                    Manfaat dari aplikasi sistem pakar ini adalah untuk dapat memberikan pengetahuan kepada
                    pasien dengan cepat bagaimana cara mengatasi penyakit pada tulang.
                </p>
